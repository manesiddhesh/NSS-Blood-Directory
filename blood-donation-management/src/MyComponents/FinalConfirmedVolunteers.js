...
export default function FinalConfirmedVolunteers() {
                        ...
                        {activity_list.map((item, index) => {
                            return (
                                <tr key={item.id}>
                                    ...
                                    <td>
                                        <Link to={`/VolunteersList/${item.id}`}>
                                            <button className="btn btn-edit">View Confirmed Volunteers for this Camp</button>
                                        </Link>
                                    </td>
                                </tr>
                            );
